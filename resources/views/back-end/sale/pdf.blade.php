  ...
  <div class="voucher-area">
    ...
    <div class="dealer-info">
      ...
      <div class="customer-info">
          <span id="cn">Customer Name:</span>{{ $sale->customer->name }}<span></span><br/>
          <span id="cp">Customer Phone:</span>{{ $sale->customer->phone }}<span></span>
      </div>

      <div class="voucher-number">
          <p>
          	<span id="vn">Order No:</span> <span>{{ $sale->order_no }}</span><br/>
        ...
        <div class="total-amount">
         ...
         <p> 
          <span id="ta">Total Amount: </span> 
           ...
           {{ $sale->payment->paid_amount }}

           <br/>

           <span id="ta">Due Amount: </span> 
           {{ $sale->payment->due_amount }}
