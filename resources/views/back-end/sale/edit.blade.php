                      ...
                      <input type="hidden" name="id" value="{{ $sale->id }}">
                       ...
                       <div class="form-group col-lg-4">
                          ...
                          <select class="form-control select2" name="customer_group_id" style="width: 100%;" id="customer_group_id">
                              ...
                              <option value="{{ $group->id }}" {{ $group->id==$sale->customer_group_id?'selected':'' }}>
                                {{ $group->name }}
                              </option>
                              @endforeach
                          </select>
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <select class="form-control select2" name="payment_type" style="width: 100%;">
                              ...
                              <option value="{{ $bank->bank_slug }}" {{ $bank->bank_slug==$sale->payment->payment_type?'selected':'' }}>
                                {{ $bank->bank_name }}
                              </option>
                              @endforeach
                          </select>
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <input type="text" name="order_no" class="form-control" value="{{ $sale->order_no }}" readonly="">
                            @error('order_no')
                            <span class="text-danger">{{ $message }}</span>
                           @enderror
                        </div>
                      ...
                      @endforeach
                        ...
                        <tfoot>
                          <tr>
                            ...
                            <td>Sub Total:</td>
                            <td>
                              <input type="text" name="total_amount" class="form-control subtotal" value="{{ $sale->total_amount }}" readonly>
                            </td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>Paid Amount:</td>
                            <td>
                              <input type="text" name="paid_amount" class="form-control paid_amount" value="{{ $sale->payment->paid_amount }}">
                            </td>
                          </tr>
                          <tr>
                            <td colspan="3"></td>
                            <td>Due Amount:</td>
                            <td>
                              <input type="text" name="due_amount" class="form-control due_amount" value="{{ $sale->payment->due_amount }}">
                            </td>
...
$(function() {
    ...
    $(document).on('change', '#customer_group_id', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                var selectedCustomerId = "{{ $sale->customer_id }}"; // Previous selected customer ID
                $('#customer_id').empty();
