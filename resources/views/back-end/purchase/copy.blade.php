              ...
              <form action="{{ route('sale.store') }}" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <tr>
                       <td class="col-lg-2">
                         <select class="form-control" name="product_group_id[]"><option selected="selected">Select here</option>@foreach( $product_groups as $show1)<option value="{{ $show1->id }}">{{ $show1->name }}</option>@endforeach</select>
                       </td>
                        <td class="col-lg-3">
                         <select class="form-control" name="product_id[]"><option selected="selected">Select here</option>@foreach( $products as $show)<option value="{{ $show->id }}">{{ $show->name }}</option>@endforeach</select>
                       </td>
...
$(function(){
    ...
    function addRow() {
        var tr = '<tr>' +
            ' <td class="col-lg-2"><select class="form-control" name="product_group_id[]"><option selected="selected">Select here</option>@foreach( $product_groups as $show1)<option value="{{ $show1->id }}">{{ $show1->name }}</option>@endforeach</select></td>'+
            '<td class="col-lg-3"><select class="form-control" name="product_id[]"><option selected="selected">Select here</option>@foreach($products as $show)<option value="{{ $show->id }}">{{ $show->name }}</option>@endforeach</select></td>' +
